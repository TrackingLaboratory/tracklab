...
from pbtrack.datastruct.detections import Detection, Metadata, Keypoint, Bbox
...
class DEKRDetector(Detector):
    def __init__(self, cfg, device, vis_threshold=0.3):
        self.cfg = cfg
        self.device = device

        self.model = eval("models." + cfg.MODEL.NAME + ".get_pose_net")( #  TODO ugly
