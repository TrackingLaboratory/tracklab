...
""" run_posetrack_reid_challenge.py
"""
...
if __name__ == '__main__':
    ...
    default_metrics_config = {'METRICS': ['HOTAReidKeypoints'] }
    ...
    # Run code
    evaluator = trackeval.EvaluatorReid(eval_config)
    dataset_list = [trackeval.datasets.PoseTrackReID(dataset_config)]
    metrics_list = []
