...
from dd_sort.simformer.motionbert.drop import DropPath
...
def load_motion_bert_weights(model_backbone, chk_filename):
...
class DSTformer(nn.Module):
    def __init__(self, dim_in=3, dim_out=3, dim_feat=256, dim_rep=512,
                 ...
                 qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0., drop_path_rate=0., norm_layer=partial(nn.LayerNorm, eps=1e-6), att_fuse=True):
        super().__init__()
