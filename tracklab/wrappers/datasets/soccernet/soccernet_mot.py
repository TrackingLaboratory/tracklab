...
def load_set(dataset_path):
    ...
    image_metadata = image_metadata[['video_id', 'frame', 'file_path', 'is_labeled']]
    detections = detections[['image_id', 'video_id', 'track_id', 'person_id', 'bbox_ltwh', 'bbox_conf', 'class', 'visibility']]
